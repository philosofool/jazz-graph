...
See [`data_normalization.py`](https://github.com/philosofool/jazz-graph/blob/main/src/jazz_graph/clean/data_normalization.py) for exact process and examples and [`test_data_normalization.py`](https://github.com/philosofool/jazz-graph/blob/main/tests/clean/test_data_normalization.py) for tests, most of which are extracted from actual cases.
