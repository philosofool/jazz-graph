		...
		\begin{columns}[t]
			...
			\begin{column}{0.32\textwidth}
				...
				\begin{block}{Recommendation}
					...
					$$
					where $gnn$ is the embedding learned from the graph of jazz performances, artists and songs and $agg$ is an aggregation or pooling function. Experiments were run with \emph{max}, \emph{sum} and \emph{softmax-wieghting}.
