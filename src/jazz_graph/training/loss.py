...
def nt_xent_loss_with_masking_(z, positive_mask, temperature=0.5):
    ...
    # Also exclude diagonal from positive mask
    ...
    # Denominator: sum over all non-diagonal entries
    # [batch_size, 1]
    ...
    # Avoid log(0) for samples with no positives
    # Add small epsilon or filter them out
