...
description: "A full recommendation system, including data pipeline, graph construction, self-supervised graph neural network learn, and recommendations system."
format:
   html:
    code-tools: true
    code-overflow: wrap
